...
В будущем `AiGarden` может развиться из сервиса анализа растений по фото в полноценного цифрового помощника для садоводства.

Основные направления развития:

- ИИ-анализ упаковок семян: распознавание культуры, сорта и рекомендаций по посадке и уходу
- карта сада: отметка, где и какие растения растут на участке
- история посадок: просмотр, что росло в конкретном месте по месяцам и годам
- учет сортов без бумажных упаковок и табличек на грядках
- привязка к региону и прогнозу погоды
- предупреждения о заморозках, засухе, сильных дождях и других рисках
- рекомендации по уходу: укрыть, утеплить, полить или отложить полив
- ИИ-рекомендации по оптимальной расстановке растений на участке

Такой функционал позволит объединить в одной системе анализ растений, учет посадок, карту участка и климатические рекомендации.
